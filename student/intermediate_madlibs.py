""" 
In this implementation, we ask the user to input certain strings. After we print our MadLibs,
we want to ask the user whether they want to do another round. They can input "yes" or "no".
Depending on their input, we either ask them to play again or we end the program. 
"""

# Taking in input and printing is already taking care for you below
# TODO: Add in the feature where before the user is prompted for the following inputs, they can choose to terminate the program
